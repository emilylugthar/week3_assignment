...
If you left join the two datasets only using variety, you will have two vegetable variables: vegetable.x and vegetable.y. You can fix this by joining with both variety and vegetable. 
